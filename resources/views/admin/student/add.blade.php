                        ...
                        <form id="studentForm" enctype="multipart/form-data">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <label>Roll No</label>
                                    <input type="number" class="form-control" name="roll_no" value="{{ old('roll_no') }}" placeholder="Enter Roll Number" required>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="tel" class="form-control" name="phone_no" value="{{ old('phone_no') }}" placeholder="Enter Phone Number" required>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control" name="admission_no" value="{{ old('admission_no') }}" placeholder="Enter Admission Number" required>
                                </div>
                                <div class="form-group col-md-6">
...
<script>
    document.getElementById('studentForm').addEventListener('submit', function(event) {
        ...
        axios.post('{{ url("admin/student/create") }}', formData)
            .then(response => {
