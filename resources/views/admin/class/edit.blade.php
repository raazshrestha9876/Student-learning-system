                        ...
                        <form id="classForm">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{old('name', $class->name)}}" placeholder="Enter Class Name">
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
...
<script>
    ...
    classForm.addEventListener('submit', function(event) {
        ...
        axios.post("{{url('admin/class/update/'.$class->id)}}", formData)
            .then((response) => {
